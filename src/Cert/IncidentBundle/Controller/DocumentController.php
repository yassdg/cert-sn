...
use Cert\IncidentBundle\Entity\Document;
use Cert\IncidentBundle\Form\DocumentType;
...
class DocumentController extends Controller
{
    ...
    //fonction uploadActio pour charger un fichier
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('CertIncidentBundle:Document')->findAll();

        return $this->render('CertIncidentBundle:Document:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('CertIncidentBundle:Document:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('CertIncidentBundle:Document')->find($id);
        ...
        return $this->render('CertIncidentBundle:Document:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('CertIncidentBundle:Document:edit.html.twig', array(
            'entity'      => $entity,
